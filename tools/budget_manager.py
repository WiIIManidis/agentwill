...
class BudgetManager:
    ...
    PHASE_CONFIG = {
        "Seed": {
            ...
            "base_mrr_gain":              10.0,
            "base_mrr_gain_scale":        5.0,
            "mrr_growth_factor":          0.05,
            "mrr_growth_factor_scale":    0.02,
        ...
        "Pre-Seed": {
            ...
            "base_mrr_gain":              25.0,
            "base_mrr_gain_scale":        10.0,
            "mrr_growth_factor":          0.07,
            "mrr_growth_factor_scale":    0.03,
        ...
        "Series B": {
            ...
            "base_mrr_gain":              100.0,
            "base_mrr_gain_scale":        50.0,
            "mrr_growth_factor":          0.12,
            "mrr_growth_factor_scale":    0.07,
        ...
        "Series C": {
            ...
            "base_mrr_gain":              200.0,
            "base_mrr_gain_scale":        100.0,
            "mrr_growth_factor":          0.15,
            "mrr_growth_factor_scale":    0.08,
        ...
        "Exit Prep": {
            ...
            "campaign_cost":              600.0,   # Final push campaigns
            ...
            "campaign_success_probability": 0.9,
