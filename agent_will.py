...
- select_niche: Commit to a specific business niche based on research findings ÃÂ¢ÃÂÃÂ use this after perform_market_research
        ...
        if action_type == "agent_action":
            ...
            if action == "perform_market_research":
                ...
                self.log_action(
                    ...
                    outcome="Success ÃÂ¢ÃÂÃÂ niche committed to state.json"
                )
                self.action_queue.appendleft({"tool": "agent_action", "tool_input": {"action_name": "move_to_next_objective"}})
                return True
